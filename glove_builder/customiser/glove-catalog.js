...
export const T = {
  en: {
    ...
    viewBack: 'Back', viewPalm: 'Palm', viewThumb: 'Thumb side', viewPinky: 'Pinky side', viewHeel: 'Heel',
    ...
    seeOnThumb: 'See it on the thumb side', seeOnPinky: 'See it on the pinky side',
    kanjiNotDrawn: 'Kanji is stitched by SSK in Japanese characters, which the preview cannot show. The text is ordered as typed.',
  ...
  nl: {
    ...
    viewBack: 'Achterkant', viewPalm: 'Palm', viewThumb: 'Duimzijde', viewPinky: 'Pinkzijde', viewHeel: 'Hiel',
    ...
    seeOnThumb: 'Bekijk op de duimzijde', seeOnPinky: 'Bekijk op de pinkzijde',
    kanjiNotDrawn: 'Kanji wordt door SSK in Japanse tekens geborduurd; de preview kan dat niet laten zien. De tekst wordt besteld zoals getypt.',
