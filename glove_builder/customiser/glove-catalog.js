...
export const T = {
  en: {
    ...
    hoodNotDrawn: 'The hood is ordered as chosen; only the finger pad has been photographed, so the picture shows no hood.',
  ...
  nl: {
    ...
    hoodNotDrawn: 'De kap wordt besteld zoals gekozen; alleen het vingerpad is gefotografeerd, dus op de afbeelding staat geen kap.',
